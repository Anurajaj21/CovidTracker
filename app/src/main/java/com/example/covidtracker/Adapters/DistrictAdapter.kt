...
import com.example.covidtracker.Models.DistrictResponseItem
import com.example.covidtracker.Models.Statewise
import com.example.covidtracker.R
import kotlinx.android.synthetic.main.each_state.view.*

class DistrictAdapter(val list : ArrayList<DistrictResponseItem>): RecyclerView.Adapter<DistrictAdapter.DistrictViewHolder>() {
...
//        holder.view.name.text = list[position].districtData?
